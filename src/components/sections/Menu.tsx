    ...
    <section id="menu" className="py-20 md:py-32 bg-background">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="mt-12 md:mt-20 text-center">
          <Link href="/menu">
            <Button className="rounded-full px-8 py-4 md:px-12 md:py-6 bg-white text-black hover:bg-primary hover:text-black transition-all font-black tracking-[0.2em] uppercase text-[10px] md:text-base shadow-2xl group w-full md:w-auto h-auto">
              Explore Full Menu
